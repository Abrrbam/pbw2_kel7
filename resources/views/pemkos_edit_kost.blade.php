...
<body>
    <header>
        ...
        <h1 class="telkozy"><a href="beranda_pemkos.php" style="color: inherit;">Telkozy</a></h1>
    </header>
        ...
        <div class="top">
            <div class="edit-kost">
                ...
                <div class="image-kost" data-toggle="modal" data-target="#editPhotoModal">
                    <input type="file" name="foto-kost" id="foto-kost" style="display: none;" accept="image/*">

                    <?php if (!empty($data['foto'])) : ?>
                        <img src="src/img/kost/<?= $data['foto']; ?>" id="foto-kost">
                    <?php endif; ?>
            ...
            <div class="informasi-kost-edit">
                <form method="POST" action="proses_edit_kost.php?id_kost=<?= $data['id_kost']; ?>" enctype="multipart/form-data">
                    <label for="nama_kost">
                        <h1>Nama Kost</h1>
                    </label> <br>
                    <input type="text" name="nama_kost" value="<?= htmlspecialchars($data['nama_kost']); ?>"> <br>
                    <label for="nama_daerah">
                        <h1>Nama Daerah</h1>
                    </label> <br>
