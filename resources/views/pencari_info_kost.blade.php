...
<body>
  <header>
    ...
    <h1 class="telkozy"><a href="beranda_pencari.php">Telkozy</a></h1>
  </header>
  ...
  <div class="container">
    <div class="container-detail">
      <div class="box-foto-kost">
        <div class="foto-kost">
          <img src="src/img/kost/<?= htmlspecialchars($kost['foto']) ?>" alt="Foto Kost">
        </div>
      ...
      <div class="informasi-kost">
        ...
        <h2 class="harga" style="font-size: 25px;">Rp<?= number_format($kost['harga'], 0, ',', '.') ?> <span>/tahun</span></h2>
        ...
        <p>Untuk informasi lebih lengkap, hubungi kontak yang tertera diatas</p>

        <hr>
        <h1 style="font-size: 30px;">Alamat</h1>
        <p><?= htmlspecialchars($kost['alamat']) ?></p>
